...
export class Program implements IProgram {
    static build = (programDTO: ProgramDTO) => {
        ...
        program.days = programDTO.days
            .map(d => Day.createFrom(d))
            .sort((a, b) => a.date.valueOf() - b.date.valueOf()) as Day[];
        ...
        program.updatedAt = programDTO.updatedAt
...
export class DisplayProgram implements IProgram {
    static build = (programDTO: ProgramDTO) => {
        ...
        program.id = programDTO.id;
        program.name = programDTO.name;
        program.startDate = programDTO.startDate
            ? dayjs(programDTO.startDate)
            : null;
        ...
        program.athleteId = programDTO.athleteId ? programDTO.athleteId : '';
        program.athleteName = programDTO.athleteName
            ? programDTO.athleteName
            : '';
